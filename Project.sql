...
CREATE TABLE `Customer` (
  ...
  `Country` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `Postal` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
...
(
SELECT CustomerID, a.OrderID, c.Name, Quantity, a.Price, Quantity * a.Price AS Total, OrderDate, ShipDate, Status 
FROM OrderRecord a 
INNER JOIN Orders b ON a.OrderID = b.OrderID 
INNER JOIN Products c ON a.SKU = c.SKU 
WHERE CustomerID = CustomerIDInput
UNION
SELECT CustomerID, OrderID, "Reimburse", "", "", SUM(Amount) * -1 AS Total, "", "", ""
FROM Reimbursement c
WHERE CustomerID = CustomerIDInput
GROUP BY OrderID
UNION
SELECT CustomerID, a.OrderID, "Total Charge", "", "", SUM(Total) AS Total, "", "", ""
FROM (
...
ELSE 
    ...
    ELSE
        ...
        IF (SKU1 IS NOT NULL) THEN
            DELETE FROM Inventory WHERE SKU = SKU1;
...
ELSE
	...
	UNION
	SELECT 'Recommendation Products', GROUP_CONCAT(Name SEPARATOR ', ') AS Recommendation, '', '' FROM Products WHERE SKU IN (SELECT * FROM (
...
-- Dump completed on 2019-11-23 15:15:33
